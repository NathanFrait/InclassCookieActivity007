          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui button" href="addToFavorites.php?PaintingID=<?php echo $work['PaintingID']; ?>&ImageFileName=<?php echo $work['ImageFileName']; ?>&Title=<?php echo urlencode($work['Title']); ?>">Add to Favorites</a>
              </div>        
            </div>      
          </li>
